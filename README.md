...
HeartXtract is a Python based framework that can used to extract characterize heart structure and patient descriptions from MIMIC-III notes following a hierarchical numerical coding system.
